...
const discount_handler_1 = require("./discount.handler");
...
function registerConnectionHandler(io) {
    ...
    (0, discount_handler_1.registerDiscountHandler)(io);
    ...
    io.on("connection", (socket) => {
        ...
        socket.on(events_1.CLIENT_EVENTS.JOIN_ROOM, (payload) => {
            ...
            (0, discount_handler_1.syncRecorderDiscountOverlay)(socket, joinResult.room);
        });
